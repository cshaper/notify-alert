        ...
        <div
          className={
            !isOpen
              ? styles.out +
                ' ' +
                styles.NotifyAlertlContainer +
                ' ' +
                styles.six
              : styles.NotifyAlertlContainer + ' ' + styles.six
          }
        >
          <div className={styles.NotifyAlertlBackground}>
            <div className={styles.NotifyAlertMain}>
              ...
              <div className={styles.notifyAlertActions + ' ' + styles.p}>
                <button
                  className={
                    styles.notifyAlertActionsRequestBtn +
                    ' ' +
                    requestAllowBtnClassName
                  }
                  onClick={() =>
                    onActionHandle ? onActionHandle(true, type, title) : null
                  }
                >
